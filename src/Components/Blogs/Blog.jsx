...
const Blog = () => {
        return (
                <div>
                        ...
                        <h1 className='mt-5 text-1xl font-bold'><span className='text-2xl'>Question:</span> this is question answer blog</h1>
                        <h1 className='mt-2 text-1xl text-green-800 font-bold'><span className='text-2xl'> Answer:</span> this is question answer blog</h1>
                </div>
        );
};
